...
export const mockProducts: Product[] = [
  {
    ...
    categoryId: "1",
    slug: "crema-hidratante-para-pies",
    price: 25.5,
    stock: 15,
    sku: "CHP001",
    commission: 5.0,
  ...
  },
  {
    ...
    categoryId: "4",
    slug: "kit-de-instrumentos-basicos",
    price: 120.0,
    stock: 5,
    sku: "KIT004",
    status: "active",
...
export const getMockProducts = () => mockProducts.filter((p) => p.status === "active");
